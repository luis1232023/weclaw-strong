...
var agentCandidates = []agentCandidate{
	...
	{Name: "opencode-serve", Binary: "opencode", Args: []string{"serve"}, Type: "serve", Model: ""},
...
var defaultOrder = []string{
	"claude", "codex", "cursor", "kimi", "gemini", "opencode", "opencode-serve", "openclaw",
